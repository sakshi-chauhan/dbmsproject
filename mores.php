...
<h5><?php echo $row1['startdate'];?> </h5>
    ...
    <?php
$v= $row1['startdate'];
$sql = " select * from sportsp where startdate like '$v%' and id not in(select id from sportsp  where headline like '%tennis%' or link like '%tennis%' or headline like '%football%' or link like '%football%'  or headline like '%cricket%' or link like '%cricket%') ;";
...
<h5><?php echo $row1['startdate'];?> </h5>
    ...
    <?php
$v= $row1['startdate'];
$sql = " select * from sportst where startdate like '$v%' and id not in(select id from sportsp  where headline like '%tennis%' or link like '%tennis%' or headline like '%football%' or link like '%football%'  or headline like '%cricket%' or link like '%cricket%') ;";
$retval=mysql_query($sql,$con);
$var = mysql_num_rows($retval);
if( (mysql_num_rows($retval)) == 0)
...
<h5><?php echo $row1['startdate'];?> </h5>
    ...
    <?php
$v= $row1['startdate'];
$sql = " select * from sportse where startdate like '$v%' and id not in(select id from sportsp  where headline like '%tennis%' or link like '%tennis%' or headline like '%football%' or link like '%football%'  or headline like '%cricket%' or link like '%cricket%') ;";
$retval=mysql_query($sql,$con);
$var = mysql_num_rows($retval);
if( (mysql_num_rows($retval)) == 0)
...
?>
      ...
      <!-- /popular -->
       <div id="latest" class="wrap">
          ...
          <button id="popup_window" data-popup-target="#example-popup1">  <div class="spost"><img src="graphs\sports\mores\moresstat.php" width="265" height="341" onerror="this.src='images/nograph.jpg' " /> </div></button>
...
<div id="example-popup1" class="popup" >
    ...
    <!--<span class="popup-exit"></span> -->
       ...
       <img src="graphs\sports\mores\moresstat.php" width="750" height="500" onerror="this.src='images/nograph.jpg' "  />    
        </div>
    </div>
</div>
<div class="popup-overlay"></div>
          ...
          <button id="popup_window1" data-popup-target="#example-popup2">  <div class="spost"><img src="graphs\sports\mores\moresplink.php" width="260" height="341"onerror="this.src='images/nograph.jpg' " /> </div></button>
...
<div id="example-popup2" class="popup" >
    ...
    <!--<span class="popup-exit"></span> -->
        ...
        <div class="popup-content" >
       <img src="graphs\sports\mores\moresplink.php" width="750" height="500" onerror="this.src='images/nograph.jpg' "  />    
        </div>
    </div>
</div>
<div class="popup-overlay"></div>
...
<button id="popup_window" data-popup-target="#example-popup3">  <div class="spost"><img src="graphs\sports\mores\morestlink.php" width="265" height="341"onerror="this.src='images/nograph.jpg' " /> </div></button>
...
<div id="example-popup3" class="popup" >
    ...
    <!--<span class="popup-exit"></span> -->
        ...
        <div class="popup-content" >
       <img src="graphs\sports\mores\morestlink.php" width="750" height="500"onerror="this.src='images/nograph.jpg' "   />    
        </div>
    </div>
</div>
<div class="popup-overlay"></div>
...
<button id="popup_window1" data-popup-target="#example-popup4">  <div class="spost"><img src="graphs\sports\mores\moreselink.php" width="260" height="341" onerror="this.src='images/nograph.jpg' "/> </div></button>
...
<div id="example-popup4" class="popup" >
    ...
    <!--<span class="popup-exit"></span> -->
        ...
        <div class="popup-content" >
       <img src="graphs\sports\mores\moreselink.php" width="750" height="500" onerror="this.src='images/nograph.jpg' "  />    
        </div>
    </div>
</div>
<div class="popup-overlay"></div>
    ...
    <div id="sidebar">
      ...
      <div id="left">
        <div class="sitem">
          <h3>Archives</h3>
          <ul class="links">
            <li><a href="archieve\moreso.php">October 2014</a></li>
      ...
      <div id="bottom">
        <div class="sitem">
          <h3>PHOTO GALLERY</h3>
             ...
             <br />
           <br />
            <a href="#"><img src="images\new\othrsports\1.jpg" width="322" /></a>  <a href="#"></a><br/><br />
              <em></em>
            <a href="#"><img src="images\new\othrsports\2.jpg" height="362" /></a>  <a href="#"></a><br/><br />
              <em></em>
              <a href="#"><img src="images\new\ftbl\2.jpg" width="321" /></a>  <a href="#"></a><br/><br />
              <em></em>
              <a href="#"><img src="images\new\ftbl\5.jpg" width="321" /></a>  <a href="#"></a><br/><br />
              <em></em>
              <a href="#"><img src="images\new\tennis\2.jpg" width="355" height="207" /></a>  <a href="#"></a><br/>
