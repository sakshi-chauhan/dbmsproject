...
$q2 = " select * from entertainment where  (lower(headline) like '%bollywood%' or lower(link) like '%hollywood%' or lower(headline) like '%bwood%' or lower(link) like '%bwood%')  ;";
    ...
    <div id="sidebar">
      ...
      <div id="left">
        <div class="sitem">
          <h3>Archives</h3>
          <ul class="links">
            <li><a href="bollywoodo.php">October 2014</a></li>
