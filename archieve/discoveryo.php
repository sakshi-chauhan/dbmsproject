...
$q2 = " select * from science where  (link like '%science%' or headline like '%science%' or link like '%discover%' or headline like '%discover%' )  ;";
    ...
    <div id="sidebar">
      ...
      <div id="left">
        <div class="sitem">
          <h3>Archives</h3>
          <ul class="links">
            <li><a href="discoveryo.php">October 2014</a></li>
