    ...
    <div id="center">
      <div id="headline">
		...
		$con = mysql_connect('localhost','root');
		 ...
		 $search_sql="Select * from modified where headline like '%".$_GET['query']."%' or link like '%".$_GET['query']."%'";
		 $search_query=mysql_query($search_sql, $con);
		 ...
		 if(mysql_num_rows($search_query)!=0)
		 {
			 do
			 {?>
             <p><li><a href = "<?php echo $search_rs['link'] ?> "> 
    <?php
    echo "{$search_rs['headline']}  <br> ";?></a></li></p>
      ...
      <!-- /headline --><!-- /featured --><!-- /popular --><!-- /latest closed  -->
...
<!-- search process ends-->
    ...
    <a href="index.php">MRS3NEWS LIMITED 2014.</a> All Rights Reserved.</p>
        <p>
        <p>
        <!-- #BeginDate format:fcAm1m -->Saturday, October 25, 2014  2:29<!-- #EndDate -->
        <p>&nbsp; </p>
