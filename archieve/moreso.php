...
$q2 = " select * from sports where (headline not like '%cricket%' and link  not like '%cricket%') and(headline not like '%football%' and link  not like '%football%') and (headline not like '%tennis%' and link  not like '%tennis%') ;";
    ...
    <div id="sidebar">
      ...
      <div id="left">
        <div class="sitem">
          <h3>Archives</h3>
          <ul class="links">
            <li><a href="cricketo.php">October 2014</a></li>
...
<!-- search process ends-->
    ...
    <a href="index.php">MRS3NEWS LIMITED 2014.</a> All Rights Reserved.</p>
        <p>
        <p>
        <!-- #BeginDate format:fcAm1m -->Saturday, October 25, 2014  19:32<!-- #EndDate -->
        <p>&nbsp; </p>
