...
<div id="wrapper">
 <div id="header"><!-- Start WOWSlider.com BODY section --> <!-- add to the <body> of your page -->
  ...
  <div id="content">
    <div id="center">
      <div id="headline"><img src="images/header_kit-kat.png" alt=""/><strong>Design</strong>
        <p>The all new MRS3 news app is now KitKat 4.4 compliant. With it's clean look, it focuses more on content over design</p>
        <p>Explore deeper with related content on the days' biggest stories</p>
        <p>The app brings you native android animations and smoother transitions while swiping between stories</p>
        <p>All in all, the app brings in some much welcome improvements to the table</p>
        <p>&nbsp;</p>
        <p><img src="images/getit.png" alt=""/></p>
...
<!-- search process ends-->
    ...
    <a href="index.php">MRS3NEWS LIMITED 2014.</a> All Rights Reserved.</p>
        <p>
        <p>
        <!-- #BeginDate format:fcAm1m -->Saturday, October 25, 2014  17:09<!-- #EndDate -->
        <p>&nbsp; </p>
