    ...
    <div id="center">
      <div id="headline">
       ...
       <p>
                        ...
                        <b>Get Breaking News Alerts from NDTV via Email<br />
                                                                <br />
                                                                Sign up here </b>
                                                                <br />
                                                            ...
                                                            <input type="text" class="validate[required,custom[onlyLetter],length[0,100]] textbox"
                                                                name="firstname" id="firstname" style="width: 300px;" />
                                                       <br />
                                                       
                                                            <b>EMAIL</b>
                                                        
                                                            <input type="text" class="validate[required,custom[email]] textbox" name="email"
...
<!-- search process ends-->
    ...
    <a href="index.php">MRS3NEWS LIMITED 2014.</a> All Rights Reserved.</p>
        <p>
        <p>
        <!-- #BeginDate format:fcAm1m -->Saturday, October 25, 2014  14:59<!-- #EndDate -->
        <p>&nbsp; </p>
