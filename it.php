...
<h5><?php echo $row1['startdate'];?> </h5>
    ...
    <?php
$v= $row1['startdate'];
$sql = "select * from sciencep where startdate like '$v%' and  (headline like '%google%' or link like '%google%' or headline like '%facebook%' or link like '%facebook%' or headline like '%microsoft%' or link like '%microsoft%' or link like '%apple%' or headline like '%apple%') ;";
...
<h5><?php echo $row1['startdate'];?> </h5>
    ...
    <?php
$v= $row1['startdate'];
$sql = " select * from sciencet where startdate like '$v%' and  (headline like '%google%' or link like '%google%' or headline like '%facebook%' or link like '%facebook%' or headline like '%microsoft%' or link like '%microsoft%' or link like '%apple%' or headline like '%apple%');";
$retval=mysql_query($sql,$con);
$var = mysql_num_rows($retval);
if( (mysql_num_rows($retval)) == 0)
...
<h5><?php echo $row1['startdate'];?> </h5>
    ...
    <?php
$v= $row1['startdate'];
$sql = " select * from sciencee where startdate like '$v%' and  (headline like '%google%' or link like '%google%' or headline like '%facebook%' or link like '%facebook%' or headline like '%microsoft%' or link like '%microsoft%' or link like '%apple%' or headline like '%apple%') ;";
$retval=mysql_query($sql,$con);
$var = mysql_num_rows($retval);
if( (mysql_num_rows($retval)) == 0)
...
?>
     ...
     <div id="latest" class="wrap">
          ...
          <button id="popup_window" data-popup-target="#example-popup1">  <div class="spost"><img src="graphs\telecommunication\it\itstat.php" width="265" height="341" /> </div></button>
...
<div id="example-popup1" class="popup" >
    ...
    <!--<span class="popup-exit"></span> -->
       ...
       <img src="graphs\telecommunication\it\itstat.php" width="750" height="500"   />    
        </div>
    </div>
</div>
<div class="popup-overlay"></div>
          ...
          <button id="popup_window1" data-popup-target="#example-popup2">  <div class="spost"><img src="graphs\telecommunication\it\itplink.php" width="260" height="341" /> </div></button>
...
<div id="example-popup2" class="popup" >
    ...
    <!--<span class="popup-exit"></span> -->
        ...
        <div class="popup-content" >
       <img src="graphs\telecommunication\it\itplink.php" width="750" height="500"   />    
        </div>
    </div>
</div>
<div class="popup-overlay"></div>
...
<button id="popup_window" data-popup-target="#example-popup3">  <div class="spost"><img src="graphs\telecommunication\it\ittlink.php" width="265" height="341" /> </div></button>
...
<div id="example-popup3" class="popup" >
    ...
    <!--<span class="popup-exit"></span> -->
        ...
        <div class="popup-content" >
       <img src="graphs\telecommunication\it\ittlink.php" width="750" height="500"   />    
        </div>
    </div>
</div>
<div class="popup-overlay"></div>
...
<button id="popup_window1" data-popup-target="#example-popup4">  <div class="spost"><img src="graphs\telecommunication\it\itelink.php" width="260" height="341" /> </div></button>
...
<div id="example-popup4" class="popup" >
    ...
    <!--<span class="popup-exit"></span> -->
        ...
        <div class="popup-content" >
       <img src="graphs\telecommunication\it\itelink.php" width="750" height="500"   />    
        </div>
    </div>
</div>
<div class="popup-overlay"></div>
    ...
    <div id="sidebar">
      ...
      <div id="left">
        <div class="sitem">
          <h3>Archives</h3>
          <ul class="links">
            <li><a href="archieve\ito.php">October 2014</a></li>
      ...
      <div id="bottom">
        <div class="sitem">
          <h3>PHOTO GALLERY</h3>
            ...
            <br />
           <br />
            <a href="#"><img src="images\new\it\1.jpg" width="322" /></a>  <a href="#"></a><br/><br />
              <em></em>
            
              <br />
            <a href="#"><img src="images\new\it\4.jpg" width="322" /></a>  <a href="#"></a><br/><br />
              <em></em>
            <a href="#"><img src="images\new\it\5.jpg" height="358" /></a>  <a href="#"></a><br/><br />
              <em></em>
...
<!-- search process ends-->
    ...
    <a href="index.php">MRS3NEWS LIMITED 2014.</a> All Rights Reserved.</p>
        <p>
        <p>
        <!-- #BeginDate format:fcAm1m -->Monday, November 3, 2014  3:09<!-- #EndDate -->
        <p>&nbsp; </p>
