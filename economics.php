...
<h5><?php echo $row1['startdate'];?> </h5>
    ...
    <?php
$v= $row1['startdate'];
$sql = " select * from economicsp where startdate like '$v%' and link like '%economics%' or headline like '%economics%' or link like '%bank%' or headline like '%bank%' or link like '%economy%' or headline like '%economy%' or link like '%commodit%' or headline like '%commodit%' ;";
...
$sql = "select * from economicsp where startdate like '$v%' and link like '%economics%' or headline like '%economics%' or link like '%bank%' or headline like '%bank%' or link like '%economy%' or headline like '%economy%' or link like '%commodit%' or headline like '%commodit%' LIMIT $offset, $rec_limit";
...
<h5><?php echo $row1['startdate'];?> </h5>
    ...
    <?php
$v= $row1['startdate'];
$sql = " select * from economicst where startdate like '$v%' and link like '%economics%' or headline like '%economics%' or link like '%bank%' or headline like '%bank%' or link like '%economy%' or headline like '%economy%' or link like '%commodit%' or headline like '%commodit%' ;";
$retval=mysql_query($sql,$con);
$var = mysql_num_rows($retval);
if( (mysql_num_rows($retval)) == 0)
...
$sql = "select * from economicst where startdate like '$v%' and link like '%economics%' or headline like '%economics%' or link like '%bank%' or headline like '%bank%' or link like '%economy%' or headline like '%economy%' or link like '%commodit%' or headline like '%commodit%' LIMIT $offset, $rec_limit";
...
<h5><?php echo $row1['startdate'];?> </h5>
    ...
    <?php
$v= $row1['startdate'];
$sql = " select * from economicse where startdate like '$v%' and link like '%economics%' or headline like '%economics%' or link like '%bank%' or headline like '%bank%' or link like '%economy%' or headline like '%economy%' or link like '%commodit%' or headline like '%commodit%';";
$retval=mysql_query($sql,$con);
$var = mysql_num_rows($retval);
if( (mysql_num_rows($retval)) == 0)
...
$sql = "select * from economicse where startdate like '$v%' and link like '%economics%' or headline like '%economics%' or link like '%bank%' or headline like '%bank%' or link like '%economy%' or headline like '%economy%' or link like '%commodit%' or headline like '%commodit%' LIMIT $offset, $rec_limit";
...
?>
      ...
      <!-- /popular -->
       <div id="latest" class="wrap">
          ...
          <button id="popup_window" data-popup-target="#example-popup1">  <div class="spost"><img src="graphs\corporate\economics\economicsstat.php" width="265" height="341" onerror="this.src='images/nograph.jpg' " /> </div></button>
...
<div id="example-popup1" class="popup" >
    ...
    <!--<span class="popup-exit"></span> -->
       ...
       <img src="graphs\corporate\economics\economicsstat.php" width="750" height="500"   />    
        </div>
    </div>
</div>
<div class="popup-overlay"></div>
          ...
          <button id="popup_window1" data-popup-target="#example-popup2">  <div class="spost"><img src="graphs\corporate\economics\economicsplink.php" width="260" height="341" onerror="this.src='images/nograph.jpg' " /> </div></button>
...
<div id="example-popup2" class="popup" >
    ...
    <!--<span class="popup-exit"></span> -->
        ...
        <div class="popup-content" >
       <img src="graphs\corporate\economics\economicsplink.php" width="750" height="500"   />    
        </div>
    </div>
</div>
<div class="popup-overlay"></div>
...
<button id="popup_window" data-popup-target="#example-popup3">  <div class="spost"><img src="graphs\corporate\economics\economicstlink.php" width="265" height="341" onerror="this.src='images/nograph.jpg' " /> </div></button>
...
<div id="example-popup3" class="popup" >
    ...
    <!--<span class="popup-exit"></span> -->
        ...
        <div class="popup-content" >
       <img src="graphs\corporate\economics\economicstlink.php" width="750" height="500"   />    
        </div>
    </div>
</div>
<div class="popup-overlay"></div>
...
<button id="popup_window1" data-popup-target="#example-popup4">  <div class="spost"><img src="graphs\corporate\economics\economicselink.php" width="260" height="341" onerror="this.src='images/nograph.jpg' " /> </div></button>
...
<div id="example-popup4" class="popup" >
    ...
    <!--<span class="popup-exit"></span> -->
        ...
        <div class="popup-content" >
       <img src="graphs\corporate\economics\economicselink.php" width="750" height="500"   />    
        </div>
    </div>
</div>
<div class="popup-overlay"></div>
    ...
    <div id="sidebar">
      ...
      <div id="left">
        <div class="sitem">
          <h3>Archives</h3>
          <ul class="links">
            <li><a href="archieve\economicso.php">October 2014</a></li>
...
?>
      ...
      <div id="bottom">
        <div class="sitem">
          <h3>PHOTO GALLERY</h3>
          <br />
            <a href="#"><img src="images\new\economics\1.jpg" width="308" /></a>  <a href="#"></a><br/><br />
              <em></em>
            <a href="#"><img src="images\new\economics\2.jpg" /></a>  <a href="#"></a><br/><br />
              <em></em>
              <a href="#"><img src="images\new\economics\3.jpg" width="309" /></a>  <a href="#"></a><br/><br />
              <em></em>
              <a href="#"><img src="images\new\economics\4.jpg" width="310" /></a>  <a href="#"></a><br/><br />
              <em></em>
              <a href="#"><img src="images\new\economics\5.jpg" width="312" height="134" /></a>  <a href="#"></a><br/><br />
              <em></em>
              <a href="#"><img src="images\new\economics\6.jpg" width="308" /></a>  <a href="#"></a><br/><br />
              <em></em>
              <a href="#"><img src="images\new\economics\7.jpg" width="310" /></a>  <a href="#"></a><br/><br />
              <em></em>
              <a href="#"><img src="images\new\economics\8.jpg" /></a>  <a href="#"></a><br/><br />
              <em></em>
...
<!-- search process ends-->
    ...
    <a href="index.php">MRS3NEWS LIMITED 2014.</a> All Rights Reserved.</p>
        <p>
        <p>
        <!-- #BeginDate format:fcAm1m -->Monday, November 3, 2014  16:51<!-- #EndDate -->
        <p>&nbsp; </p>
