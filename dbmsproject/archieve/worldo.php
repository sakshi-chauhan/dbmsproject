    ...
    <div id="sidebar">
      ...
      <div id="left">
        <div class="sitem">
          <h3>Archives</h3>
          <ul class="links">
            <li><a href="worldo.php">October 2014</a></li>
      ...
      <div id="right">
        <div class="sitem">
		  ...
		  $q = "select * from blog order by startdate desc limit 5;";
		  $r = mysql_query($q,$con);
		  while($row1 = mysql_fetch_array($r))
		  {
		  ?>
          <br />
		  <a href = "<?php echo $row1['../link'] ?>" > <?php
		  echo $row1['headline'] ?></a>
		  <?php
		  }?>
...
<!-- search process ends-->
    ...
    <a href="index.php">MRS3NEWS LIMITED 2014.</a> All Rights Reserved.</p>
        <p>
        <p>
        <!-- #BeginDate format:fcAm1m -->Saturday, October 25, 2014  19:40<!-- #EndDate -->
        <p>&nbsp; </p>
