...
$q2 = " select * from entertainment where  (lower(headline) like '%tv%' or lower(link) like '%television%' or lower(headline) like '%television%' or lower(link) like '%tv%')  ;";
    ...
    <div id="sidebar">
      ...
      <div id="left">
        <div class="sitem">
          <h3>Archives</h3>
          <ul class="links">
            <li><a href="tvo.php">October 2014</a></li>
