...
$q2 = " select * from entertainment where  (lower(headline) like '%hollywood%' or lower(link) like '%hollywood%' or lower(headline) like '%hwood%' or lower(link) like '%hwood%')  ;";
    ...
    <div id="sidebar">
      ...
      <div id="left">
        <div class="sitem">
          <h3>Archives</h3>
          <ul class="links">
            <li><a href="hollywoodo.php">October 2014</a></li>
