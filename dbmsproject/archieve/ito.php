...
$q2 = " select * from science where (headline like '%google%' or link like '%google%' or headline like '%facebook%' or link like '%facebook%' or headline like '%microsoft%' or link like '%microsoft%' or link like '%apple%' or headline like '%apple%')  ;";
    ...
    <div id="sidebar">
      ...
      <div id="left">
        <div class="sitem">
          <h3>Archives</h3>
          <ul class="links">
            <li><a href="ito.php">October 2014</a></li>
