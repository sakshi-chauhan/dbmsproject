...
<div id="wrapper">
 <div id="header"><!-- Start WOWSlider.com BODY section --> <!-- add to the <body> of your page -->
  ...
  <div id="content">
    <div id="center">
      <div id="headline">
      <form  id="fb" style="margin:0px; margin-top:4px;" action="www.googleplus.com"target="_blank"  >
         <input type="submit" value="Go to GOOGLE+ Page" >
     </form>
...
<!-- search process ends-->
    ...
    <a href="index.php">MRS3NEWS LIMITED 2014.</a> All Rights Reserved.</p>
        <p>
        <p>
        <!-- #BeginDate format:fcAm1m -->Saturday, October 25, 2014  18:46<!-- #EndDate -->
        <p>&nbsp; </p>
