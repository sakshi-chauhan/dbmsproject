<?php
include("file:///E|/xampp/htdocs/project/one1/graphs/world/phpgraphlib.php");
$graph = new PHPGraphLib(400,400);
$con = mysql_connect('localhost','root') or die('could not connect:' . mysql_error());
mysql_select_db('testdata') or die ('could not select database');
$data = array();
$q1= "select SUBSTRING(link,8,15) as `slink` , count(*) as `count`  from lifestylee group by slink;";
