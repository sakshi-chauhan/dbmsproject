...
$data = array();
$q1= "select SUBSTRING(link,8,15) as `slink` , count(*) as `count`  from entertainmentt where lower(headline) like '%tv%' or lower(link) like '%television%' or lower(headline) like '%television%' or lower(link) like '%tv%' group by slink;";
