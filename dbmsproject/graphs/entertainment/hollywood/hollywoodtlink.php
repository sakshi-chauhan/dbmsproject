...
$data = array();
$q1= "select SUBSTRING(link,8,15) as `slink` , count(*) as `count`  from entertainmentt where lower(headline) like '%hollywood%' or lower(link) like '%hollywood%' or lower(headline) like '%hwood%' or lower(link) like '%hwood%' group by slink;";
