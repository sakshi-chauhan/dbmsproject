...
$data = array();
$q1= "select count(*) as `count` from entertainmentp where lower(headline) like '%hollywood%' or lower(link) like '%hollywood%' or lower(headline) like '%hwood%' or lower(link) like '%hwood%' ;";
$result1 = mysql_query($q1);
$q2= "select count(*) as `count` from entertainmentt where lower(headline) like '%hollywood%' or lower(link) like '%hollywood%' or lower(headline) like '%hwood%' or lower(link) like '%hwood%' ;";
$result2 = mysql_query($q2);
$q3= "select count(*) as `count` from entertainmente where lower(headline) like '%hollywood%' or lower(link) like '%hollywood%' or lower(headline) like '%hwood%' or lower(link) like '%hwood%';";
