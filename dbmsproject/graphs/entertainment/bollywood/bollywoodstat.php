...
$data = array();
$q1= "select count(*) as `count` from entertainmentp where lower(headline) like '%bollywood%' or lower(link) like '%bollywood%' or lower(headline) like '%bwood%' or lower(link) like '%bwood%' ;";
$result1 = mysql_query($q1);
$q2= "select count(*) as `count` from entertainmentt where lower(headline) like '%bollywood%' or lower(link) like '%bollywood%' or lower(headline) like '%bwood%' or lower(link) like '%bwood%' ;";
$result2 = mysql_query($q2);
$q3= "select count(*) as `count` from entertainmente where lower(headline) like '%bollywood%' or lower(link) like '%bollywood%' or lower(headline) like '%bwood%' or lower(link) like '%bwood%' ;";
