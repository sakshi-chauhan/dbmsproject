...
$data = array();
$q1= "select count(*) as `count` from sciencep where link like '%science%' or headline like '%science%' or link like '%discover%' or headline like '%discover%' ;";
$result1 = mysql_query($q1);
$q2= "select count(*) as `count` from  sciencee where link like '%science%' or headline like '%science%' or link like '%discover%' or headline like '%discover%' ;";
$result2 = mysql_query($q2);
$q3= "select count(*) as `count` from  sciencet where link like '%science%' or headline like '%science%' or link like '%discover%' or headline like '%discover%' ;";
