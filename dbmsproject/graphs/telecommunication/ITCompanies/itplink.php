...
$data = array();
$q1= "select SUBSTRING(link,8,15) as `slink` , count(*) as `count`  from sciencep where headline like '%google%' or link like '%google%' or headline like '%facebook%' or link like '%facebook%' or headline like '%microsoft%' or link like '%microsoft%' or link like '%apple%' or headline like '%apple%' group by slink;";
