...
$data = array();
$q1= "select count(*) as `count` from sportsp where headline like '%football%' or link like '%football%' ;";
$result1 = mysql_query($q1);
$q2= "select count(*) as `count` from  sportst where headline like '%football%' or link like '%football%';";
$result2 = mysql_query($q2);
$q3= "select count(*) as `count` from sportse where headline like '%football%' or link like '%football%';";
