...
$data = array();
$q1= "select count(*) as `count` from sportsp where headline like '%cricket%' or link like '%cricket%' ;";
$result1 = mysql_query($q1);
$q2= "select count(*) as `count` from  sportst where headline like '%cricket%' or link like '%cricket%';";
$result2 = mysql_query($q2);
$q3= "select count(*) as `count` from sportse where headline like '%cricket%' or link like '%cricket%';";
