...
$data = array();
$q1= "select count(*) as `count` from multimediap where headline like '%video%' or link like '%video%';";
$result1 = mysql_query($q1);
$q2= "select count(*) as `count` from multimediat where headline like '%video%' or link like '%video%';";
$result2 = mysql_query($q2);
$q3= "select count(*) as `count` from multimediae where headline like '%video%' or link like '%video%';";
