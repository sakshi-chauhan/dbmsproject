  ...
  <div id="content">
    <div id="center">
      <div id="headline">
        ...
        <p><img src="images/mrs3app.jpg" alt="MRS3"/> MRS3 App brings the latest, biggest news and much more from India's most respected and largest private television network. 

You can follow breaking news and latest updates as they happen through stories, pictures and videos on demand. 

Watch live video of leading group channels – MRS3 24x7, MRS3 India, MRS3 Profit, streamed directly from the studios.</p>
       <h1>FREE </h1>
       <p>By installing you agree to the Terms of Use andother terms</p>                             
      </div>
...
<!-- search process ends-->
    ...
    <a href="index.php">MRS3NEWS LIMITED 2014.</a> All Rights Reserved.</p>
        <p>
        <p>
        <!-- #BeginDate format:fcAm1m -->Saturday, October 25, 2014  18:31<!-- #EndDate -->
        <p>&nbsp; </p>
