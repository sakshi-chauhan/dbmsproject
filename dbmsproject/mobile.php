 ...
 <div id="header"><!-- Start WOWSlider.com BODY section --> <!-- add to the <body> of your page -->
  ...
  <div id="content">
    <div id="center">
      ...
      <h1><marquee> MRS3 Active</marquee></h1>
     
     
      <div id="insideleftcont">
      <p class="fbld">Visit the site on your mobile browser, or SMS 'ACTIVE' to 56388</p>
      <h2>Description</h2><p>Get the latest and biggest news and much more from India's most respected and largest private television network.</p>
      <p>The MRS3 WAP site brings you stories, pictures and videos from the MRS3 network. Award-winning journalists and technology combine to report on Politics, Business, Cricket and Bollywood.<br /></p>
      <h2>Read</h2><br /></p>
      <ul><li>Breaking news, top stories, India, world,  business, sports news and more.</li><li>Full coverage of news events.</li><li>City news and popular stories.</li></ul><p><h2>Watch & View</h2>
      </p><ul><li>Daily video updates from the world of news, entertainment, sports, lifestyle, business, gadgets and health.</li><li>Top videos from all categories, most popular and  the best of MRS3.</li><li>Photo galleries and slideshows.</li></ul><p><h2>Cricket</h2></p><ul><li>Get live Cricket scores with a full scorecard.</li><li>Follow every ball bowled in international ODIs, Tests and T20 matches.</li></ul><p><h2>iWitness</h2></p><ul><li>Contribute to MRS3’s coverage on stories that are important to you</li><li>View, record and submit videos and photos directly from your phone</li></ul><p><b>MRS3. Experience. Truth. First.</b></p></div>
...
<!-- search process ends-->
    ...
    <a href="index.php">MRS3NEWS LIMITED 2014.</a> All Rights Reserved.</p>
        <p>
        <p>
        <!-- #BeginDate format:fcAm1m -->Saturday, October 25, 2014  15:28<!-- #EndDate -->
        <p>&nbsp; </p>
