...
<div id="wrapper">
 <div id="header"><!-- Start WOWSlider.com BODY section --> <!-- add to the <body> of your page -->
  ...
  <div id="content">
    <div id="center">
      <div id="headline">
        <h1><marquee>MRS3 APPS</marquee></h1>
        <p><a href="http://www.ndtv.com/page/ndtv-news-ipad-app">News on iPad</a></p>
        <p>Redesigned for iOS 7</p>
        <p>The all-new iPad app, now in the native iOS7 experience. Watch Live TV, flip the app to consume content in Hindi and more.</p>
        <p>
        <a href="#"><img src="images/apple-app-store-btn_new.png" alt="" /></a></p>
        <p>&nbsp;</p>
        <p><a href="http://www.ndtv.com/page/ios7">News for iPhone</a></p>
        <br />
        <p>All new MRS3 News iPhone app with iOS 7 native experience, Hindi section, live interactive weather and more.</p>
        <p><a href="#"><img src="images/apple-app-store-btn_new.png" alt="" /></a></p>
        <br />
       
          <p><a href="#">MRS3 Gadgets App</a></p>
          <p>Download India&rsquo;s first Gadgets and technology news app. Get latest reviews, news and watch your favourite shows like Gadget Guru on the move. <a href="#" title="iOS" target="_blank"><img src="images/apple-app-store-btn_new.png" alt="" /></a>   
          <a href="#" title="Android" target="_blank"><img src="images/android-app-store-btn.png" alt="" /></a></p>
        
         <a href="#."><img src="images/ndtv_android_icon.png" alt="" border="0" align="left" /></a>
          <p><a href="#">News on Android</a>Hindi Section</p>
          <p>The app keeps you updated with breaking news form MRS3 newsroom. You can also watch videos of your favorite news programmes.</p>
          <p><a href="#"><img src="images/android-app-store-btn.png" alt="" /></a>   <a href="#"><img src="images/amazon-apps-store-us-gray.png" alt="" /></a></p>
        
       
        
       
        <a href=""><img src="images/ndtv_news_icon_news.png" alt="" border="0" align="left" /></a>
          <p><a href="">MRS3 News for Windows 8</a></p>
          <p>MRS3 App brings the latest, biggest news and much more from India's most respected and largest private television network. Customised to work seamlessly on your Windows 8 devices, the app comes with live tiles, snap view, share charms integration and much more.</p>
          <p><a href="">Download Here</a></p>
      <a href=""><img src="images/blackberry-_new_thumb-rhs.png" alt="" border="0" align="left" /></a>
          <p><a href="">News on BlackBerry</a></p>
          <p>The all new MRS3 App with faster navigation, Live TV, videos and more. Get news on the go on your BlackBerry phone.</p>
          <p><a href=""><img src="images/bb_world.png" alt="" /></a></p>
      
        
          
       <a href="#"><img src="images/nokia-profit-thumb.png" alt="" border="0" align="left" /></a>
          <p><a href="#">MRS3 Profit on Nokia Phones</a></p>
          <p>Get Live markets, latest business news updates, analysis and videos on your Nokia Phones</p>
          <p><a href="#">Download For Symbian Touch Phones</a></p>
      
      
          <a href="#"><img src="images/win-phone-nokia-ndtv-small.png?ver1" alt="" border="0" align="left" /></a>
          <p><a href="#">MRS3 News on Windows Phone</a></p>
          <p>Get news, video, photos, live streaming, cricket scores and more on Windows Phone devices. Supports live tiles and notifications.
          </p>
         
        
        <a href="#"><img src="images/nokia_app_thumb1.png" alt="" border="0" align="left" /></a>
          <p><a href="#">MRS3 News on Nokia Phones</a></p>
          <p>Stay updated with latest news, pictures and videos on your Nokia smartphones.</p>
          <p><a href="#">Download for Symbian Touch Phones</a></p>
          <p><a href="#">Download for S40 &amp; Symbian Non-Touch phones</a></p>
        
          <a href="#"><img src="images/ultrabook_trending_thumb.png" alt="" border="0" align="left" /></a>
          <p><a href="#">MRS3 Trending for Intel AppUp®</a></p>
          <p>MRS3 Trending tells you what is hot and happening right now. Follow the top trending news stories, videos, photos and more. Find out what users and surfers are reading and watching.</p>
          
        
        <a href="#"><img src="images/slate_icon.png" alt="" border="0" align="left" /></a>
          <p><a href="#">MRS3 News on Slate</a></p>
          <p>An exclusive app for Windows 7 Slate devices. Follow the news from MRS3 channels directly on your slate device.</p>
          
        
      <a href="#"><img src="images/fb_apps_icon.png" alt="" border="0" align="left" /></a>
          <p><a href="#">Facebook</a></p>
          <p>Access more than 150,000 videos. Watch, Share, Discuss.</p>
...
<!-- search process ends-->
    ...
    <a href="index.php">MRS3NEWS LIMITED 2014.</a> All Rights Reserved.</p>
        <p>
        <p>
        <!-- #BeginDate format:fcAm1m -->Saturday, October 25, 2014  16:44<!-- #EndDate -->
        <p>&nbsp; </p>
