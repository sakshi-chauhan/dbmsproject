...
<h5><?php echo $row1['startdate'];?> </h5>
    ...
    <?php
$v= $row1['startdate'];
$sql = " select * from sciencep where startdate like '$v%' and  ( headline like '%mobile%' or link like '%mobile%' or headline like '%app%' or link like '%app%' or headline like '%android%' or link like '%android%' or link like '%phone%' or headline like '%phone%' or headline like '%PC%' or link like '%PC%' or headline like '%computer%' or link like '%computer%' or headline like '%laptop%' or link like '%laptop%' or link like '%tab%' or headline like '%tab%' or headline like '%gadget%' or link like '%gadget%' or headline like '%tech%') ;";
...
<h5><?php echo $row1['startdate'];?> </h5>
    ...
    <?php
$v= $row1['startdate'];
$sql = " select * from sciencet where startdate like '$v%' and  ( headline like '%mobile%' or link like '%mobile%' or headline like '%app%' or link like '%app%' or headline like '%android%' or link like '%android%' or link like '%phone%' or headline like '%phone%' or headline like '%PC%' or link like '%PC%' or headline like '%computer%' or link like '%computer%' or headline like '%laptop%' or link like '%laptop%' or link like '%tab%' or headline like '%tab%' or headline like '%gadget%' or link like '%gadget%' or headline like '%tech%') ;";
$retval=mysql_query($sql,$con);
$var = mysql_num_rows($retval);
if( (mysql_num_rows($retval)) == 0)
...
<h5><?php echo $row1['startdate'];?> </h5>
    ...
    <?php
$v= $row1['startdate'];
$sql = " select * from sciencee where startdate like '$v%' and  ( headline like '%mobile%' or link like '%mobile%' or headline like '%app%' or link like '%app%' or headline like '%android%' or link like '%android%' or link like '%phone%' or headline like '%phone%' or headline like '%PC%' or link like '%PC%' or headline like '%computer%' or link like '%computer%' or headline like '%laptop%' or link like '%laptop%' or link like '%tab%' or headline like '%tab%' or headline like '%gadget%' or link like '%gadget%' or headline like '%tech%') ;";
$retval=mysql_query($sql,$con);
$var = mysql_num_rows($retval);
if( (mysql_num_rows($retval)) == 0)
...
?>
      ...
      <!-- /popular -->
       <div id="latest" class="wrap">
          ...
          <button id="popup_window" data-popup-target="#example-popup1">  <div class="spost"><img src="graphs\telecommunication\technology\technologystat.php" width="265" height="341" onerror="this.src='images/nograph.jpg'" /> </div></button>
...
<div id="example-popup1" class="popup" >
    ...
    <!--<span class="popup-exit"></span> -->
       ...
       <img src="graphs\telecommunication\technology\technologystat.php" width="750" height="500"   />    
        </div>
    </div>
</div>
<div class="popup-overlay"></div>
          ...
          <button id="popup_window1" data-popup-target="#example-popup2">  <div class="spost"><img src="graphs\telecommunication\technology\technologyplink.php" width="260" height="341" onerror="this.src='images/nograph.jpg'" /> </div></button>
...
<div id="example-popup2" class="popup" >
    ...
    <!--<span class="popup-exit"></span> -->
        ...
        <div class="popup-content" >
       <img src="graphs\telecommunication\technology\technologyplink.php" width="750" height="500"   />    
        </div>
    </div>
</div>
<div class="popup-overlay"></div>
...
<button id="popup_window" data-popup-target="#example-popup3">  <div class="spost"><img src="graphs\telecommunication\technology\technologytlink.php" width="265" height="341" onerror="this.src='images/nograph.jpg'" /> </div></button>
...
<div id="example-popup3" class="popup" >
    ...
    <!--<span class="popup-exit"></span> -->
        ...
        <div class="popup-content" >
       <img src="graphs\telecommunication\technology\technologytlink.php" width="750" height="500"   />    
        </div>
    </div>
</div>
<div class="popup-overlay"></div>
...
<button id="popup_window1" data-popup-target="#example-popup4">  <div class="spost"><img src="graphs\telecommunication\technology\technologyelink.php" width="260" height="341" onerror="this.src='images/nograph.jpg'" /> </div></button>
...
<div id="example-popup4" class="popup" >
    ...
    <!--<span class="popup-exit"></span> -->
        ...
        <div class="popup-content" >
       <img src="graphs\telecommunication\technology\technologyelink.php" width="750" height="500"   />    
        </div>
    </div>
</div>
<div class="popup-overlay"></div>
    ...
    <div id="sidebar">
      ...
      <div id="left">
        <div class="sitem">
          <h3>Archives</h3>
          <ul class="links">
            <li><a href="archieve\technologyo.php">October 2014</a></li>
...
?>
      ...
      <div id="bottom">
        <div class="sitem">
          <h3>PHOTO GALLERY</h3>
          <br />
            <a href="#"><img src="images\new\tech\1.jpg" width="322" /></a>  <a href="#"></a><br/><br />
              <em></em>
            <a href="#"><img src="images\new\tech\2.jpg" height="362" /></a>  <a href="#"></a><br/><br />
              <em></em>
              <a href="#"><img src="images\new\tech\3.jpg" width="355" height="207" /></a>  <a href="#"></a><br/>
              <em></em>
              <br />
            <a href="#"><img src="images\new\tech\4.jpg" width="322" /></a>  <a href="#"></a><br/><br />
              <em></em>
...
<!-- search process ends-->
    ...
    <a href="index.php">MRS3NEWS LIMITED 2014.</a> All Rights Reserved.</p>
        <p>
        <p>
        <!-- #BeginDate format:fcAm1m -->Monday, November 3, 2014  16:56<!-- #EndDate -->
        <p>&nbsp; </p>
