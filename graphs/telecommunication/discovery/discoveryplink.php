...
$data = array();
$q1= "select SUBSTRING(link,8,15) as `slink` , count(*) as `count`  from sciencep where link like '%science%' or headline like '%science%' or link like '%discover%' or headline like '%discover%' group by slink;";
