...
$data = array();
$q1= "select SUBSTRING(link,8,15) as `slink` , count(*) as `count`  from entertainmentp where lower(headline) like '%bollywood%' or lower(link) like '%bollywood%' or lower(headline) like '%bwood%' or lower(link) like '%bwood%' group by slink;";
