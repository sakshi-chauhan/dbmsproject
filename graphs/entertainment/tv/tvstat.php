...
$data = array();
$q1= "select count(*) as `count` from entertainmentp where lower(headline) like '%tv%' or lower(link) like '%television%' or lower(headline) like '%television%' or lower(link) like '%tv%';";
$result1 = mysql_query($q1);
$q2= "select count(*) as `count` from entertainmentt where lower(headline) like '%tv%' or lower(link) like '%television%' or lower(headline) like '%television%' or lower(link) like '%tv%' ;";
$result2 = mysql_query($q2);
$q3= "select count(*) as `count` from entertainmente where lower(headline) like '%tv%' or lower(link) like '%television%' or lower(headline) like '%television%' or lower(link) like '%tv%' ;";
