...
?>
     ...
     <div id="latest" class="wrap">
          ...
          <button id="popup_window" data-popup-target="#example-popup1">  <div class="spost"><img src="graphs\entertainment\bollywood\bollywoodstat.php" width="265" height="341" onerror="this.src='images/nograph.jpg' " /> </div></button>
...
<div class="popup-overlay"></div>
          ...
          <button id="popup_window1" data-popup-target="#example-popup2">  <div class="spost"><img src="graphs\entertainment\bollywood\bollywoodplink.php" width="260" height="341" onerror="this.src='images/nograph.jpg' " /> </div></button>
...
<button id="popup_window" data-popup-target="#example-popup3">  <div class="spost"><img src="graphs\entertainment\bollywood\bollywoodtlink.php" width="265" height="341" onerror="this.src='images/nograph.jpg' " /> </div></button>
...
<button id="popup_window1" data-popup-target="#example-popup4">  <div class="spost"><img src="graphs\entertainment\bollywood\bollywoodelink.php" width="260" height="341" onerror="this.src='images/nograph.jpg' " /> </div></button>
