...
<h5><?php echo $row1['startdate'];?> </h5>
    ...
    <?php
$v= $row1['startdate'];
$sql = " select * from extrap where startdate like '$v%' ;";
...
<h5><?php echo $row1['startdate'];?> </h5>
    ...
    <?php
$v= $row1['startdate'];
$sql = " select * from extrat where startdate like '$v%' ;";
$retval=mysql_query($sql,$con);
$var = mysql_num_rows($retval);
if( (mysql_num_rows($retval)) == 0)
...
<h5><?php echo $row1['startdate'];?> </h5>
    ...
    <?php
$v= $row1['startdate'];
$sql = " select * from extrae where startdate like '$v%' ;";
$retval=mysql_query($sql,$con);
$var = mysql_num_rows($retval);
if( (mysql_num_rows($retval)) == 0)
...
?>
      ...
      <!-- /popular -->
       <div id="latest" class="wrap">
          ...
          <button id="popup_window" data-popup-target="#example-popup1">  <div class="spost"><img src="graphs\others\moreo\moreostat.php" width="265" height="341" onerror="this.src='images/nograph.jpg' " /> </div></button>
...
<div id="example-popup1" class="popup" >
    ...
    <!--<span class="popup-exit"></span> -->
       ...
       <img src="graphs\others\moreo\moreostat.php" width="750" height="500"   />    
        </div>
    </div>
</div>
<div class="popup-overlay"></div>
          ...
          <button id="popup_window1" data-popup-target="#example-popup2">  <div class="spost"><img src="graphs\others\moreo\moreoplink.php" width="260" height="341" onerror="this.src='images/nograph.jpg' " /> </div></button>
...
<div id="example-popup2" class="popup" >
    ...
    <!--<span class="popup-exit"></span> -->
        ...
        <div class="popup-content" >
       <img src="graphs\others\moreo\moreoplink.php" width="750" height="500"   />    
        </div>
    </div>
</div>
<div class="popup-overlay"></div>
...
<button id="popup_window" data-popup-target="#example-popup3">  <div class="spost"><img src="graphs\others\moreo\moreotlink.php" width="265" height="341" onerror="this.src='images/nograph.jpg' " /> </div></button>
...
<div id="example-popup3" class="popup" >
    ...
    <!--<span class="popup-exit"></span> -->
        ...
        <div class="popup-content" >
       <img src="graphs\others\moreo\moreotlink.php" width="750" height="500"   />    
        </div>
    </div>
</div>
<div class="popup-overlay"></div>
...
<button id="popup_window1" data-popup-target="#example-popup4">  <div class="spost"><img src="graphs\others\moreo\moreoelink.php" width="260" height="341" onerror="this.src='images/nograph.jpg' " /> </div></button>
...
<div id="example-popup4" class="popup" >
    ...
    <!--<span class="popup-exit"></span> -->
        ...
        <div class="popup-content" >
       <img src="graphs\others\moreo\moreoelink.php" width="750" height="500"   />    
        </div>
    </div>
</div>
<div class="popup-overlay"></div>
    ...
    <div id="sidebar">
      ...
      <div id="left">
        <div class="sitem">
          <h3>Archives</h3>
          <ul class="links">
            <li><a href="archieve\moreoo.php">October 2014</a></li>
      ...
      <div id="bottom">
        <div class="sitem">
          <h3>PHOTO GALLERY</h3>
           ...
           <br />
            <a href="#"><img src="images\new\moreo\1.jpg" width="322" /></a>  <a href="#"></a><br/><br />
              <em></em>
            <a href="#"><img src="images\new\moreo\2.jpg" height="362" /></a>  <a href="#"></a><br/><br />
              <em></em>
              <a href="#"><img src="images\new\moreo\3.jpg" width="355" height="207" /></a>  <a href="#"></a><br/>
              <em></em>
              <br />
